...
class Admin(models.Model):
    ...
    owner = models.CharField(
        help_text="full name of owner", max_length=100, blank=True, null=True)
    image = models.ImageField(help_text="image preview in admin panel might look either condensed or pixelated, ignore that",
                              upload_to='admin/', blank=True, null=True, default='default/admin.png')
    desc = models.TextField(max_length=100, blank=True, null=True)
    address = models.CharField(max_length=100,  blank=True, null=True)
    number = models.PositiveIntegerField(
        help_text="append 91 infront of your number eg 919917956610", blank=True, null=True)
    greeting = models.CharField(
        max_length=100,  blank=True, null=True, default='Hi%20there')
    email = models.EmailField(blank=True, null=True)
    website = models.URLField(blank=True, null=True)
    youtube = models.URLField(
        help_text="URL of the profile", blank=True, null=True)
    ...
    telegram = models.URLField(
        help_text="https://t.me/username", blank=True, null=True)
...
class Author(models.Model):
    ...
    website = models.URLField(blank=True, null=True)
    instagram = models.URLField(
        help_text="URL of the profile", blank=True, null=True, unique=True)
    youtube = models.URLField(
        help_text="URL of the profile", blank=True, null=True)
    twitter = models.URLField(
        help_text="URL of the profile", blank=True, null=True, unique=True)
    reddit = models.URLField(
        help_text="URL of the profile", blank=True, null=True, unique=True)
    telegram = models.URLField(
        help_text="https://t.me/username", blank=True, null=True, unique=True)
    github = models.URLField(
        help_text="URL of the profile", blank=True, null=True, unique=True)
    linkedin = models.URLField(
        help_text="URL of the profile", blank=True, null=True, unique=True)
    gitlab = models.URLField(
        help_text="URL of the profile", blank=True, unique=True, null=True)
    quora = models.URLField(help_text="URL of the profile",
...
class Post(models.Model):
    ...
    slug = models.SlugField(help_text="don't edit this, if you don't know what you are doing",
